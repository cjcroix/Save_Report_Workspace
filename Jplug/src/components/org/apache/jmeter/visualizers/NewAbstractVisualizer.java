 ...
 *
 */
public abstract class NewAbstractVisualizer
    ...
    protected NewResultCollector collector = new NewResultCollector();

    protected boolean isStats = false;

    public NewAbstractVisualizer()  {
        super();
     ...
     */
    protected NewResultCollector getModel() {
        return collector;
    }
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        collector = (NewResultCollector) createTestElement();
    ...
    public TestElement createTestElement() {
        if (collector == null) {
            collector = new NewResultCollector();
        }
    ...
    public void modifyTestElement(TestElement c) {
        ...
        if (c instanceof NewResultCollector) {
        	NewResultCollector rc = (NewResultCollector) c;
    ...
    public void configure(TestElement el) {
        super.configure(el);
        setFile(el.getPropertyAsString(NewResultCollector.FILENAME));
        NewResultCollector rc = (NewResultCollector) el;
     ...
     * @param collector
     */
    protected void setModel(NewResultCollector collector) {
